...
public class Profile_Category_GridView_ImageAdapter extends ArrayAdapter<Profile_Category_Grid_Model> {

    private Context mContext;
    private int layoutResourceId;
    private ArrayList<Profile_Category_Grid_Model> mGridData = new ArrayList<Profile_Category_Grid_Model>();

    public Profile_Category_GridView_ImageAdapter(Context mContext, int layoutResourceId, ArrayList<Profile_Category_Grid_Model> mGridData) {
     ...
     * @param mGridData
     */
    public void setGridData(ArrayList<Profile_Category_Grid_Model> mGridData) {
        this.mGridData = mGridData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Profile_Category_Grid_Model item = mGridData.get(position);
