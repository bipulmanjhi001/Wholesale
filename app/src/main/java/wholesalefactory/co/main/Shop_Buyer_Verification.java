...
public class Shop_Buyer_Verification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop__buyer__verification);
        ...
        gst_06.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (gst_06_on.isChecked()) {
                    Intent intent = new Intent(Shop_Buyer_Verification.this, SetProfile.class);
        ...
        back_from_buyer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                startActivity(new Intent(Shop_Buyer_Verification.this, Proof.class));
            }
        });
    }
    ...
    public void backButtonHandler() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Shop_Buyer_Verification.this);
        ...
        alertDialog.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Shop_Buyer_Verification.this.finish();
                    }
                });
