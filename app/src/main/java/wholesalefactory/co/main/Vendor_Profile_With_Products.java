...
import wholesalefactory.co.adapter.Profile_Category_GridView_ImageAdapter;
import wholesalefactory.co.api.URLs;
import wholesalefactory.co.model.ExpandableHeightGridView;
import wholesalefactory.co.model.Profile_Category_Grid_Model;
import wholesalefactory.co.model.VolleySingleton;

public class Vendor_Profile_With_Products extends AppCompatActivity {

    Profile_Category_GridView_ImageAdapter profile_category_gridView_imageAdapter;
    ExpandableHeightGridView expandableHeightGridView;
    ProgressBar progressBar;
    ArrayList<Profile_Category_Grid_Model> products_with_profileModels;
    private static final String SHARED_PREF_NAME = "wholesalepref";
    private static final String KEY_ID = "token";
    String tokens;
    String user_id,user_ids,shop_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendor__profile__with__products);
        ...
        expandableHeightGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Profile_Category_Grid_Model profile_category_grid_model=(Profile_Category_Grid_Model)adapterView.getItemAtPosition(i);
                Intent intent=new Intent(Vendor_Profile_With_Products.this,Profile_Product_One_Display.class);
                intent.putExtra("pro_id",profile_category_grid_model.getId());
                intent.putExtra("name", profile_category_grid_model.getNames());
                intent.putExtra("subcategory_id", profile_category_grid_model.getProductcategory());
                intent.putExtra("productcategory_id",  profile_category_grid_model.getProductsubcategory());
                intent.putExtra("image", profile_category_grid_model.getPro_img());
                intent.putExtra("category",  profile_category_grid_model.getCategory());
                intent.putExtra("category_pro_url",  profile_category_grid_model.getPro_img());
        ...
        products_with_profileModels=new ArrayList<Profile_Category_Grid_Model>();
        ...
        product_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Vendor_Profile_With_Products.this,Cart.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        back_from_productdetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Vendor_Profile_With_Products.this,Home.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.URL_userlistings,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                            ...
                            if(obj.getBoolean("status")) {
                                ...
                                for(int j = 0; j < toparr.length(); j++){
                                    try {
                                        ...
                                        Profile_Category_Grid_Model profile_category_grid_model=new Profile_Category_Grid_Model();
                        ...
                        profile_category_gridView_imageAdapter = new Profile_Category_GridView_ImageAdapter(Vendor_Profile_With_Products.this, R.layout.profile_category_gridview, products_with_profileModels);
